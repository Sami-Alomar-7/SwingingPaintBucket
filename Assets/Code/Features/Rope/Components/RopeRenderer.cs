...
{
    /// <summary>
    /// MonoBehaviour that renders the pendulum rope via LineRenderer while
    /// also implementing IRope so PendulumController can call UpdateRope without
    /// knowing about LineRenderer.
    ///
    /// The rope is treated as a fixed-length segment: the start of the segment is
    /// always at the pivot and the end is the bucket position every frame.
    /// </summary>
    ...
    public class RopeRenderer : MonoBehaviour, IRope
    {
        ...
        private void InitializeLineRenderer()
        {
            ...
            // Use the built-in Sprites/Default shader (always present; produces a solid unlit colour)
